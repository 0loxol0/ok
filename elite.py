...
def menu():
    ...
    print('%s╠══[%s•%s] %sName : Ahmed Alzwage %s'%(O,P,O,P,users))
    print('%s╠══[%s•%s] %sEmail : ahmedalzwage.01@gmail.com%s'%(O,P,O,P,maile))
